...
def apply_relative_median_short_confirmation(
    ...
    tolerance = float(strategy_config.get("short_confirmation_tolerance") or 0.0)
    ...
    for candidate in candidates:
        ...
        updated_candidate["short_confirmation_threshold"] = threshold
        ...
        elif threshold is None or float(updated_candidate["return_10d"]) >= float(threshold):
