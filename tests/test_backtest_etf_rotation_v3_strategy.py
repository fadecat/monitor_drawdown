...
import backtest_etf_rotation_v3_strategy as module
...
def test_replay_rotation_v3_keeps_single_positive_score_asset_in_risk_mode():
    series_by_label = {
        "A": _make_series(
            "A",
            [
...
def test_run_backtest_v3_writes_required_stage1_outputs():
